    ...
    return (
        <div className={styles.invoiceContainer}>
            <div className={styles.invoiceTopSection}>
                ...
                <h1 className={styles.invoiceTitle}>智能开票</h1>
                <div className={styles.invoiceQuestionInput}>
                    <QuestionInput
            ...
            <div className={styles.invoiceBottomSection}>
                ...
                {!isLoading && answer && !error && (
                    <div className={styles.invoiceAnswerContainer}>
                        <Answer
                            answer={answer}
                            isStreaming={false}
                ...
                {activeAnalysisPanelTab && answer && (
                    <AnalysisPanel
                        className={styles.invoiceAnalysisPanel}
            ...
            >
                <TextField
                    className={styles.invoiceSettingsSeparator}
                ...
                />
                <TextField className={styles.invoiceSettingsSeparator} label="Exclude category" onChange={onExcludeCategoryChanged} />
                <Checkbox
                    className={styles.invoiceSettingsSeparator}
